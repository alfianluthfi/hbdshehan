...
const pages = [
    ...
    { img: "sts10.jpg", text: "Cantik banget yaa bunganyaa, jumlah mawarnya penuh makna. Sukak bangett pokoknyaaa"},
...
===================== */
const textOnlyPages = [
    "Sayangku, semangat ya semoga hari ini sayang di diberkahi apapun itu, di kelilingi hal-hal baik. semoga, hidup selalu di lancarkan ya sayang. i know you're trying your best, even on days when you feel like you're not enough. tapi percaya deh, sayang cukup, sayang selalu cukup. Dunia ini emang ga selalu ramah, tapi sayang selalu punya tempat untuk kembali entah itu dalam doa, dalam ingatan, atau dalam hati seseorang yang beneran peduli sama sayang. i hope today brings you a little peace, even if it's small. i'm proud of you, really.  Udah sejauh ini, dan itu keren banget. Mungkin sayang ga nyadar, tapi kehadiran sayang aja udah cukup buat bikin dunia jadi sedikit lebih hangat. dan kalau nanti hari mulai terasa berat lagi, sayang boleh istirahat sebentar, ga harus terus kuat kok, ga harus pura-pura baik-baik aja. it's okay to feel tired, to cry, to pause. yang penting jangan berhenti. Hidup itu bukan tentang siapa yang paling cepat sampai, tapi siapa yang tetap mau jalan meskipun pelan. Jangan biarin dunia yang keras ini ngubah jadi oranglain. karena sayang, dengan segala cara sayang bertahan, udah luar biasa banget. and maybe someday, when everything feels lighter, you'll look back and smile. realizing that all those little steps you took, all those quiet nights you survived, were the things that brought you here. so, keep going, okay? the world still needs your light. reminder.",
    "Sayang aku tau kalo lagi banyak pikiran, aku bisa ngerasain dari cara sayang bales, dari cara sayang diem dan dari caranya sayang pura pura keliatan baik baik aja padahal aku tau banget sebenarnya sayang lagi ga baik,aku ngerti kok kalo gamau cerita atau belum siap cerita aku cuma sayang tau kalo sayang ga harus ngadepin semuanya sendirian, sayang tuh punya aku,dan aku ada di sini bukan cuma buat nemenin sayang pas seneng aja tapi juga buat peluk sayang pas dunia lagi nyakitin sayang, jangan merasa sendiri ya semestaku.",
...
btn.addEventListener("click", () => {
    ...
    caption.innerHTML = "Shehan Talsya Syavira ❤️";
    caption.classList.remove("hidden");
...
finishBtn.addEventListener("click", () => {
    caption.innerHTML = "Terima kasih sudah membaca kisah cinta ini 💖";
    caption.classList.remove("hidden");
    choice.classList.add("hidden");
});
